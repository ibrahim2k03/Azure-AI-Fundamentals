...
1. [What is an AI application?](#what-is-an-ai-application)
2. [Key AI workloads](#key-ai-workloads)
3. [Types of ML](#types-of-ml)
4. [AI Applications](#ai-applications)
5. [Components of an AI application](#components-of-an-ai-application)
